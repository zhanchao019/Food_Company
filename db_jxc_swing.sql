...
INSERT INTO `tb_goods` VALUES ('4', '牙膏', '中国', '30', '牙膏', '21377128', '231739832', '牙膏', 12, '2', 1);
INSERT INTO `tb_goods` VALUES ('5', '可贺', '上海市', '30', '钱', '21321342', '213232147', '可乐', 3, '3', 1);
INSERT INTO `tb_goods` VALUES ('6', '锤子', '茂名', '30', '杠精', '1', '1', '数据库再错我上去就是一锤子', 1, '1', 1);
INSERT INTO `tb_goods` VALUES ('7', '鼠标', '山东', '30', '键盘侠', '1', '1', '看看触发器', 1, '1', 1);
...
-- ----------------------------
INSERT INTO `tb_producingdetail` VALUES ('SI20191213012059', '1', 'K3drgc8OOn', '2', 2, '2019-12-18 00:00:00', 'out');
...
-- Records of tb_sales
-- ----------------------------
INSERT INTO `tb_sales` VALUES ('SI20191211101310', '1', '现金', '2019-12-11 10:13:10', 'admin', 2, 3, '人人', '1', '已出货', 'out');
INSERT INTO `tb_sales` VALUES ('SI20191213011706', '1', '支票', '2019-12-13 01:17:06', 'admin', 1, 3, 'nill', '5', '已出货', 'out');
INSERT INTO `tb_sales` VALUES ('SI20191213012059', '1', '现金', '2019-12-13 01:20:59', 'admin', 1, 7, '12313', '1', '现货', 'out');
INSERT INTO `tb_sales` VALUES ('SI20191213012322', '1', '现金', '2019-12-13 01:23:22', 'admin', 1, 3, 'all', '1', '已出货', 'Saleback');
INSERT INTO `tb_sales` VALUES ('SI20191214120901', '1', '现金', '2019-12-14 12:09:01', '', 3, 6, '应该时2*3', '1', '已出货', 'out');
INSERT INTO `tb_sales` VALUES ('SI20191214131022', '1', '现金', '2019-12-14 13:10:22', 'admin', 123131, 1477580, '', '4', '已出货', 'out');
INSERT INTO `tb_sales` VALUES ('SI20191214132024', '2', '现金', '2019-12-14 13:20:24', '', 1, 33, '', '2', '已出货', 'out');
INSERT INTO `tb_sales` VALUES ('SI20191214132101', '2', '现金', '2019-12-14 13:21:01', '', 1999, 5997, '', '5', '已出货', 'out');
INSERT INTO `tb_sales` VALUES ('SI20191214132234', '1', '银行卡', '2019-12-14 13:22:34', '', 10, 1477340, '', '1', '已出货', 'out');
...
-- ----------------------------
INSERT INTO `tb_storage` VALUES ('1', 'XmMxDG0PXq', 'SI20191211101310', '2019-12-18 00:00:00', 'out');
INSERT INTO `tb_storage` VALUES ('1', 'XmMxDG0PXq', 'SI20191211101310', '2019-12-18 00:00:00', 'out');
INSERT INTO `tb_storage` VALUES ('1', 'XmMxDG0PXq', 'SI20191211101310', '2019-12-18 00:00:00', 'out');
INSERT INTO `tb_storage` VALUES ('1', 'XmMxDG0PXq', 'SI20191211101310', '2019-12-18 00:00:00', 'out');
INSERT INTO `tb_storage` VALUES ('1', 'XmMxDG0PXq', 'SI20191211101310', '2019-12-18 00:00:00', 'out');
INSERT INTO `tb_storage` VALUES ('1', 'XmMxDG0PXq', 'SI20191211101310', '2019-12-18 00:00:00', 'out');
INSERT INTO `tb_storage` VALUES ('1', 'XmMxDG0PXq', 'SI20191214202114', '2019-12-18 00:00:00', 'in');
INSERT INTO `tb_storage` VALUES ('1', 'XmMxDG0PXq', 'demo', '2019-12-18 00:00:00', 'in');
INSERT INTO `tb_storage` VALUES ('1', 'XmMxDG0PXq', 'demo', '2019-12-18 00:00:00', 'in');
INSERT INTO `tb_storage` VALUES ('1', 'XmMxDG0PXq', 'demo', '2019-12-18 00:00:00', 'in');
INSERT INTO `tb_storage` VALUES ('1', 'K3drgc8OOn', 'demo', '2019-12-18 00:00:00', 'in');
INSERT INTO `tb_storage` VALUES ('1', 'K3drgc8OOn', 'demo', '2019-12-18 00:00:00', 'in');
INSERT INTO `tb_storage` VALUES ('1', 'K3drgc8OOn', 'demo', '2019-12-18 00:00:00', 'in');
INSERT INTO `tb_storage` VALUES ('1', 'K3drgc8OOn', 'demo', '2019-12-18 00:00:00', 'in');
INSERT INTO `tb_storage` VALUES ('1', '88UyoLEVAn', 'demo', '2019-12-18 00:00:00', 'in');
INSERT INTO `tb_storage` VALUES ('1', '88UyoLEVAn', 'demo', '2019-12-18 00:00:00', 'in');
INSERT INTO `tb_storage` VALUES ('1', 'XmMxDG0PXq', 'demo', '2019-12-18 00:00:00', 'in');
...
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pr_getAllOnTimeSalesIn`()
BEGIN
...
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pr_getAllOrderedSalesIn`()
BEGIN
     select * from tb_sales 
...
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pr_updateStorage`()
BEGIN
...
CREATE DEFINER = `root`@`localhost` TRIGGER `deal` AFTER UPDATE ON `tb_sales` FOR EACH ROW BEGIN
	...
	IF new.paid = 'true' THEN
		...
		set tmp1 = tmp1-num;
			...
			where (tb_storage.goodsid=new.goodsid and tb_storage.orderid='NULL') LIMIT num;
